...
function Auto(color, ruedas, motor, puertas) {
    ...
    this.acelerar = function(){
        alert('A' + (this.velocidad += 50 ) + 'km/h' )
    }

} 

let auto = new Auto('Rojo', 4, 1.8, 2)
console.log(auto);
auto.acelerar()

let auto2 = new Auto('Azul', 4 ,1.6, 4)
...
class Auto {
    ...
    constructor(color, ruedas, motor, puertas) {
